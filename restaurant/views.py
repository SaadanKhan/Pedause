...
class BookRestaurant(APIView):
    ...
    def post(self, request):
        try:
            ...
            if UserRestaurantBooking.objects.filter(user=request.user, restaurant=rest_id).first():
                return Response({
                'success': False,
            ...
            if check_restaurant_availability(rest_id, member) == False:
                return Response({
                'success': False,
                ...
                if restaurant:
                    ...
                    user_rest = UserRestaurantBooking(
                        user=custom_user, 
